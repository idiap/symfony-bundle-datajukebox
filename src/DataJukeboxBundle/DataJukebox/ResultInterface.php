...
// DataJukeboxBundle\DataJukebox\ResultInterface.php
 ...
 *
 * <P>This interface wraps the methods required to abstract data result
 * processing.</P>
 *
 * @package    DataJukeboxBundle
 */
interface ResultInterface
{
  ...
  /** Returns the associated data browser
