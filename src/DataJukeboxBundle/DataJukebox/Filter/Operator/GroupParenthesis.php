...
// DataJukeboxBundle\DataJukebox\Filter\Operator\GroupParenthesis.php
 ...
 * @subpackage Operator
 */
class GroupParenthesis
  extends Expression\Operator\GroupParenthesis
{

  /*
   * METHODS: Expression\GroupParenthesis
   ********************************************************************************/

  public function evaluate(Expression\Node $oLeft, Expression\Node $oRight, array $amParameters)
  {
    return sprintf('(%s)', $oRight->evaluate($amParameters));
  }
