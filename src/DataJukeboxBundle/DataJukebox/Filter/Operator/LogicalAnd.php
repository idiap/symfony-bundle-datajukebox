...
// DataJukeboxBundle\DataJukebox\Filter\Operator\LogicalAnd.php
 ...
 */
class LogicalAnd
  extends Expression\Operator\LogicalAnd
{

  /*
   * METHODS: Expression\LogicalAnd
   ********************************************************************************/
  ...
  public function evaluate(Expression\Node $oLeft, Expression\Node $oRight, array $amParameters)
  {
    ...
    return sprintf('%s AND %s', $mLeft, $mRight);
  }
