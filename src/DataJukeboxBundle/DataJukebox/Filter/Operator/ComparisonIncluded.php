...
// DataJukeboxBundle\DataJukebox\Filter\Operator\ComparisonIncluded.php
...
class ComparisonIncluded
  extends Expression\Operator\ComparisonIncluded
{

  /*
   * METHODS: Expression\ComparisonIncluded
   ********************************************************************************/
  ...
  public function evaluate(Expression\Node $oLeft, Expression\Node $oRight, array $amParameters)
  {
    ...
    return sprintf('%s IN (%s)',$oLeft->evaluate($amParameters), implode(',',$aRight));
  }
