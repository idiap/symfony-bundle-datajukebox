...
// DataJukeboxBundle\DataJukebox\Filter\Operator\ComparisonBiggerOrEqual.php
...
/** Comparison: bigger-or-equal (>=)
 *
 * @package    FilterLanguage
 * @subpackage Operator
 */
class ComparisonBiggerOrEqual
  extends Expression\Operator\ComparisonBiggerOrEqual
{

  /*
   * METHODS: Expression\ComparisonBiggerOrEqual
   ********************************************************************************/
