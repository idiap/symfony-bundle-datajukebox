...
// DataJukeboxBundle\DataJukebox\Filter\Operator\ComparisonEqual.php
...
class ComparisonEqual
  extends Expression\Operator\ComparisonEqual
{

  /*
   * METHODS: Expression\ComparisonEqual
   ********************************************************************************/
  ...
  public function evaluate(Expression\Node $oLeft, Expression\Node $oRight, array $amParameters)
  {
    ...
    if (strpos($mRight, '*') !== false or strpos($mRight, '?') !== false) {
