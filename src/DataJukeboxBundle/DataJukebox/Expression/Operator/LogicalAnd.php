...
// DataJukeboxBundle\DataJukebox\Expression\Operator\LogicalAnd.php
  ...
  extends Expression\Operator
{
  ...
  {
    return sprintf($bCompact ? '%s&&%s' : '%s and %s', $oLeft->toString($bCompact), $oRight->toString($bCompact));
  }
