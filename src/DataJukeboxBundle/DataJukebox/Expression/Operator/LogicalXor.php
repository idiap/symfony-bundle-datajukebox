...
// DataJukeboxBundle\DataJukebox\Expression\Operator\LogicalXor.php
  ...
  extends Expression\Operator
{
  ...
  {
    return sprintf($bCompact ? '%s^^%s' : '%s xor %s', $oLeft->toString($bCompact), $oRight->toString($bCompact));
  }
