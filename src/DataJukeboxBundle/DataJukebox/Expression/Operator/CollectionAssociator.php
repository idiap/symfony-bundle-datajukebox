...
// DataJukeboxBundle\DataJukebox\Expression\Operator\CollectionAssociator.php
...
/** Collection: associator (:)
 *
 * @package    ExpressionLanguage
 * @subpackage Operator
 */
class CollectionAssociator
  extends Expression\Operator
{
  ...
  public function evaluate(Expression\Node $oLeft, Expression\Node $oRight, array $amParameters)
  {
    ...
    return array($mLeft => $oRight->evaluate($amParameters));
  }
