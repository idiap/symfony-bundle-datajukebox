...
// DataJukeboxBundle\DataJukeboxBundle.php
 ...
 * @subpackage SymfonyIntegration
 */
class DataJukeboxBundle extends Bundle
{
  public function __construct() {
    \Doctrine\Common\Annotations\AnnotationRegistry::registerAutoloadNamespace('DataJukeboxBundle\Annotations', __DIR__.'/..');
  }
}
